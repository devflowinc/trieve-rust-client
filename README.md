...
*AnalyticsApi* | [**get_recommendation_analytics**](docs/AnalyticsApi.md#get_recommendation_analytics) | **POST** /api/analytics/recommendation | Get Recommendation Analytics
...
## Documentation For Models
 ...
 - [DistancePhrase](docs/DistancePhrase.md)
 ...
 - [RpsGraph](docs/RpsGraph.md)
 - [RpsGraphResponse](docs/RpsGraphResponse.md)
