...
pub async fn autocomplete(configuration: &configuration::Configuration, tr_dataset: &str, autocomplete_req_payload: models::AutocompleteReqPayload, x_api_version: Option<models::models::ApiVersion>) -> Result<models::SearchResponseTypes, Error<AutocompleteError>> {
...
pub async fn count_chunks(configuration: &configuration::Configuration, tr_dataset: &str, count_chunks_req_payload: models::CountChunksReqPayload) -> Result<models::CountChunkQueryResponseBody, Error<CountChunksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CountChunksError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_chunk(configuration: &configuration::Configuration, tr_dataset: &str, create_chunk_req_payload_enum: models::CreateChunkReqPayloadEnum) -> Result<models::ReturnQueuedChunk, Error<CreateChunkError>> {
    let local_var_configuration = configuration;
...
pub async fn get_chunk_by_id(configuration: &configuration::Configuration, tr_dataset: &str, chunk_id: &str, x_api_version: Option<models::models::ApiVersion>) -> Result<models::ChunkReturnTypes, Error<GetChunkByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_chunk_by_tracking_id(configuration: &configuration::Configuration, tr_dataset: &str, tracking_id: &str, x_api_version: Option<models::models::ApiVersion>) -> Result<models::ChunkReturnTypes, Error<GetChunkByTrackingIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_chunks_by_ids(configuration: &configuration::Configuration, tr_dataset: &str, get_chunks_data: models::GetChunksData, x_api_version: Option<models::models::ApiVersion>) -> Result<Vec<models::ChunkReturnTypes>, Error<GetChunksByIdsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_chunks_by_tracking_ids(configuration: &configuration::Configuration, tr_dataset: &str, get_tracking_chunks_data: models::GetTrackingChunksData, x_api_version: Option<models::models::ApiVersion>) -> Result<Vec<models::ChunkReturnTypes>, Error<GetChunksByTrackingIdsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recommended_chunks(configuration: &configuration::Configuration, tr_dataset: &str, recommend_chunks_request: models::RecommendChunksRequest, x_api_version: Option<models::models::ApiVersion>) -> Result<models::RecommendResponseTypes, Error<GetRecommendedChunksError>> {
    let local_var_configuration = configuration;
...
pub async fn get_suggested_queries(configuration: &configuration::Configuration, tr_dataset: &str, suggested_queries_req_payload: models::SuggestedQueriesReqPayload) -> Result<models::SuggestedQueriesResponse, Error<GetSuggestedQueriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSuggestedQueriesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn scroll_dataset_chunks(configuration: &configuration::Configuration, tr_dataset: &str, scroll_chunks_req_payload: models::ScrollChunksReqPayload) -> Result<models::ScrollChunksReqPayload, Error<ScrollDatasetChunksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScrollDatasetChunksError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_chunks(configuration: &configuration::Configuration, tr_dataset: &str, search_chunks_req_payload: models::SearchChunksReqPayload, x_api_version: Option<models::models::ApiVersion>) -> Result<models::SearchResponseTypes, Error<SearchChunksError>> {
    let local_var_configuration = configuration;
...
pub async fn update_chunk(configuration: &configuration::Configuration, tr_dataset: &str, update_chunk_req_payload: models::UpdateChunkReqPayload) -> Result<(), Error<UpdateChunkError>> {
    let local_var_configuration = configuration;
