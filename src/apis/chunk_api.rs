...
pub async fn generate_off_chunks(
    configuration: &configuration::Configuration,
    tr_dataset: &str,
    generate_off_chunks_req_payload: models::GenerateOffChunksReqPayload,
    ...
    local_var_req_builder = local_var_req_builder.json(&generate_off_chunks_req_payload);
...
) -> Result<models::ScrollChunksResponseBody, Error<ScrollDatasetChunksError>> {
    let local_var_configuration = configuration;
