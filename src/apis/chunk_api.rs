...
pub struct AutocompleteParams {
    ...
    pub autocomplete_req_payload: models::AutocompleteReqPayload
}
...
pub struct CreateChunkParams {
    ...
    pub create_chunk_req_payload_enum: models::CreateChunkReqPayloadEnum
}
...
/// struct for passing parameters to the method [`get_suggested_queries`]
#[derive(Clone, Debug)]
pub struct GetSuggestedQueriesParams {
    /// The dataset id to use for the request
    pub tr_dataset: String,
    /// JSON request payload to get alternative suggested queries
    pub suggested_queries_req_payload: models::SuggestedQueriesReqPayload
}
...
pub struct SearchChunksParams {
    ...
    pub tr_dataset: String,
    /// JSON request payload to semantically search for chunks (chunks)
    pub search_chunks_req_payload: models::SearchChunksReqPayload
}
...
pub struct UpdateChunkParams {
    ...
    pub update_chunk_req_payload: models::UpdateChunkReqPayload
}
...
pub enum GetChunkByIdSuccess {
    Status200(models::ChunkMetadataStringTagSet),
    UnknownValue(serde_json::Value),
}
...
pub enum GetChunksByIdsSuccess {
    Status200(Vec<models::ChunkMetadataStringTagSet>),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`get_suggested_queries`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSuggestedQueriesSuccess {
...
pub async fn autocomplete(configuration: &configuration::Configuration, params: AutocompleteParams) -> Result<ResponseContent<AutocompleteSuccess>, Error<AutocompleteError>> {
    ...
    let autocomplete_req_payload = params.autocomplete_req_payload;
...
pub async fn create_chunk(configuration: &configuration::Configuration, params: CreateChunkParams) -> Result<ResponseContent<CreateChunkSuccess>, Error<CreateChunkError>> {
    ...
    // unbox the parameters
    let tr_dataset = params.tr_dataset;
    let create_chunk_req_payload_enum = params.create_chunk_req_payload_enum;
...
pub async fn get_suggested_queries(configuration: &configuration::Configuration, params: GetSuggestedQueriesParams) -> Result<ResponseContent<GetSuggestedQueriesSuccess>, Error<GetSuggestedQueriesError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let tr_dataset = params.tr_dataset;
    let suggested_queries_req_payload = params.suggested_queries_req_payload;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSuggestedQueriesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn search_chunks(configuration: &configuration::Configuration, params: SearchChunksParams) -> Result<ResponseContent<SearchChunksSuccess>, Error<SearchChunksError>> {
    ...
    // unbox the parameters
    let tr_dataset = params.tr_dataset;
    let search_chunks_req_payload = params.search_chunks_req_payload;
...
pub async fn update_chunk(configuration: &configuration::Configuration, params: UpdateChunkParams) -> Result<ResponseContent<UpdateChunkSuccess>, Error<UpdateChunkError>> {
    ...
    // unbox the parameters
    let tr_dataset = params.tr_dataset;
    let update_chunk_req_payload = params.update_chunk_req_payload;
