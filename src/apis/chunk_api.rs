...
pub enum GetRecommendedChunksSuccess {
    ...
    Status206(Vec<models::SlimChunkMetadataWithScore>),
    UnknownValue(serde_json::Value),
}
...
pub enum SearchChunkSuccess {
    ...
    Status206(models::SearchSlimChunkQueryResponseBody),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`search_chunk`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchChunkError {
    Status400(models::ErrorResponseBody),
    UnknownValue(serde_json::Value),
}
