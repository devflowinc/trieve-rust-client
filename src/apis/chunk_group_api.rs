...
pub async fn add_chunk_to_group(
    ...
    tr_dataset: &str,
    group_id: &str,
    add_chunk_to_group_req_payload: models::AddChunkToGroupReqPayload,
) -> Result<(), Error<AddChunkToGroupError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddChunkToGroupError> =
...
pub async fn add_chunk_to_group_by_tracking_id(
    ...
    tracking_id: &str,
    add_chunk_to_group_req_payload: models::AddChunkToGroupReqPayload,
) -> Result<(), Error<AddChunkToGroupByTrackingIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddChunkToGroupByTrackingIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_chunk_group(
    configuration: &configuration::Configuration,
    tr_dataset: &str,
    create_chunk_group_req_payload_enum: models::CreateChunkGroupReqPayloadEnum,
) -> Result<models::CreateChunkGroupResponseEnum, Error<CreateChunkGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateChunkGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_chunk_group(
    ...
    group_id: &str,
    delete_chunks: bool,
) -> Result<(), Error<DeleteChunkGroupError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("delete_chunks", &delete_chunks.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteChunkGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_group_by_tracking_id(
    ...
    tracking_id: &str,
    delete_chunks: bool,
) -> Result<(), Error<DeleteGroupByTrackingIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteGroupByTrackingIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_chunk_group(
    ...
    tr_dataset: &str,
    group_id: &str,
) -> Result<models::ChunkGroupAndFileId, Error<GetChunkGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChunkGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_chunks_in_group(
...
) -> Result<models::GetChunksInGroupResponse, Error<GetChunksInGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChunksInGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_chunks_in_group_by_tracking_id(
    ...
    page: i64,
    x_api_version: Option<models::ApiVersion>,
) -> Result<models::GetChunksInGroupResponse, Error<GetChunksInGroupByTrackingIdError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        group_tracking_id = crate::apis::urlencode(group_tracking_id),
        page = page
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChunksInGroupByTrackingIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_group_by_tracking_id(
    ...
    tr_dataset: &str,
    tracking_id: &str,
) -> Result<models::ChunkGroupAndFileId, Error<GetGroupByTrackingIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupByTrackingIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_groups_for_chunks(
    configuration: &configuration::Configuration,
    tr_dataset: &str,
    get_groups_for_chunks_req_payload: models::GetGroupsForChunksReqPayload,
) -> Result<Vec<models::GroupsForChunk>, Error<GetGroupsForChunksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupsForChunksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_groups_for_dataset(
    ...
    dataset_id: &str,
    page: i64,
) -> Result<models::GroupData, Error<GetGroupsForDatasetError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        dataset_id = crate::apis::urlencode(dataset_id),
        page = page
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupsForDatasetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_recommended_groups(
    configuration: &configuration::Configuration,
    tr_dataset: &str,
    recommend_groups_req_payload: models::RecommendGroupsReqPayload,
    x_api_version: Option<models::ApiVersion>,
) -> Result<models::RecommendGroupsResponse, Error<GetRecommendedGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRecommendedGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_chunk_from_group(
    ...
    group_id: &str,
    chunk_id: Option<&str>,
    remove_chunk_from_group_req_payload: Option<models::RemoveChunkFromGroupReqPayload>,
) -> Result<(), Error<RemoveChunkFromGroupError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = chunk_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("chunk_id", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveChunkFromGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_over_groups(
    configuration: &configuration::Configuration,
    tr_dataset: &str,
    search_over_groups_req_payload: models::SearchOverGroupsReqPayload,
    x_api_version: Option<models::ApiVersion>,
) -> Result<models::SearchOverGroupsResponseTypes, Error<SearchOverGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchOverGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_within_group(
    configuration: &configuration::Configuration,
    tr_dataset: &str,
    search_within_group_req_payload: models::SearchWithinGroupReqPayload,
    x_api_version: Option<models::ApiVersion>,
) -> Result<models::SearchGroupResponseTypes, Error<SearchWithinGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchWithinGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_chunk_group(
    configuration: &configuration::Configuration,
    tr_dataset: &str,
    update_chunk_group_req_payload: models::UpdateChunkGroupReqPayload,
) -> Result<(), Error<UpdateChunkGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateChunkGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_group_by_tracking_id(
    ...
    tr_dataset: &str,
    tracking_id: &str,
    update_group_by_tracking_id_req_payload: models::UpdateGroupByTrackingIdReqPayload,
) -> Result<(), Error<UpdateGroupByTrackingIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateGroupByTrackingIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
