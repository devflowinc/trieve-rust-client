...
/// struct for passing parameters to the method [`clear_dataset`]
#[derive(Clone, Debug)]
pub struct ClearDatasetParams {
...
/// struct for passing parameters to the method [`delete_dataset_by_tracking_id`]
#[derive(Clone, Debug)]
pub struct DeleteDatasetByTrackingIdParams {
    /// The dataset id to use for the request
    pub tr_dataset: String,
...
/// struct for passing parameters to the method [`get_usage_by_dataset_id`]
#[derive(Clone, Debug)]
pub struct GetUsageByDatasetIdParams {
    /// The dataset id to use for the request
    pub tr_dataset: String,
...
/// struct for typed successes of method [`clear_dataset`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ClearDatasetSuccess {
    Status204(),
...
/// struct for typed successes of method [`delete_dataset_by_tracking_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteDatasetByTrackingIdSuccess {
    Status204(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed successes of method [`get_usage_by_dataset_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetUsageByDatasetIdSuccess {
    Status200(models::DatasetUsageCount),
    UnknownValue(serde_json::Value),
}
...
pub async fn clear_dataset(configuration: &configuration::Configuration, params: ClearDatasetParams) -> Result<ResponseContent<ClearDatasetSuccess>, Error<ClearDatasetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ClearDatasetSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_dataset_by_tracking_id(configuration: &configuration::Configuration, params: DeleteDatasetByTrackingIdParams) -> Result<ResponseContent<DeleteDatasetByTrackingIdSuccess>, Error<DeleteDatasetByTrackingIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteDatasetByTrackingIdSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_usage_by_dataset_id(configuration: &configuration::Configuration, params: GetUsageByDatasetIdParams) -> Result<ResponseContent<GetUsageByDatasetIdSuccess>, Error<GetUsageByDatasetIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetUsageByDatasetIdSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
