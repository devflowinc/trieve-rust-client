...
pub async fn delete_user_api_key(configuration: &configuration::Configuration, api_key_id: &str) -> Result<(), Error<DeleteUserApiKeyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/user/api_key/{api_key_id}", local_var_configuration.base_path, api_key_id=crate::apis::urlencode(api_key_id));
...
pub async fn set_user_api_key(configuration: &configuration::Configuration, set_user_api_key_request: models::SetUserApiKeyRequest) -> Result<models::SetUserApiKeyResponse, Error<SetUserApiKeyError>> {
    ...
    let local_var_uri_str = format!("{}/api/user/api_key", local_var_configuration.base_path);
...
pub async fn update_user(configuration: &configuration::Configuration, update_user_org_role_data: models::UpdateUserOrgRoleData) -> Result<(), Error<UpdateUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&update_user_org_role_data);
