...
pub struct AddChunkToGroupReqPayload {
    ...
    #[serde(rename = "chunk_tracking_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub chunk_tracking_id: Option<Option<String>>,
}

impl AddChunkToGroupReqPayload {
    pub fn new() -> AddChunkToGroupReqPayload {
        AddChunkToGroupReqPayload {
            chunk_id: None,
            chunk_tracking_id: None,
        }
    }
}
