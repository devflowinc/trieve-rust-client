...
/// BoostPhrase : Boost is useful for when you want to boost certain phrases in the fulltext search results for official listings. I.e. making sure that the listing for AirBNB itself ranks higher than companies who make software for AirBNB hosts by boosting the AirBNB token for its official listing.
...
impl BoostPhrase {
    ...
    pub fn new(boost_factor: f64, phrase: String) -> BoostPhrase {
        BoostPhrase {
            boost_factor,
            phrase,
        }
