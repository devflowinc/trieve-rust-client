...
pub struct LowConfidenceRecommendations {
...
impl LowConfidenceRecommendations {
    pub fn new(r#type: Type) -> LowConfidenceRecommendations {
...
pub enum Type {
    #[serde(rename = "low_confidence_recommendations")]
    LowConfidenceRecommendations,
}

impl Default for Type {
    fn default() -> Type {
        Self::LowConfidenceRecommendations
    }
}
