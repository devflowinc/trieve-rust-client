...
impl RagQueryEvent {
    pub fn new(created_at: String, dataset_id: uuid::Uuid, id: uuid::Uuid, rag_type: String, results: Vec<models::ChunkMetadataStringTagSet>, search_id: uuid::Uuid, user_message: String) -> RagQueryEvent {
        RagQueryEvent {
            created_at,
            dataset_id,
            id,
