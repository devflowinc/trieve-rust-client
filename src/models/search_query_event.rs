...
impl SearchQueryEvent {
    pub fn new(created_at: String, dataset_id: uuid::Uuid, id: uuid::Uuid, latency: f32, query: String, request_params: String, results: Vec<models::SearchResultType>, search_type: String, top_score: f32) -> SearchQueryEvent {
        SearchQueryEvent {
            created_at,
            dataset_id,
            id,
