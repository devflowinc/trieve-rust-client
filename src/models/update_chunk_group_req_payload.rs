...
pub struct UpdateChunkGroupReqPayload {
    ...
    #[serde(rename = "update_chunks", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub update_chunks: Option<Option<bool>>,
}

impl UpdateChunkGroupReqPayload {
    pub fn new() -> UpdateChunkGroupReqPayload {
